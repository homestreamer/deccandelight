...
class todaypk(Scraper):
    def __init__(self):
        ...
        self.bu = 'https://1todaypk.cc/category/'
        ...
        self.list = {'01Tamil Movies': 'tamil',
                     ...
                     '06Hindi Dubbed Movies': 'hindi dubbed',
                     '07Dubbed Movies': 'dubbed',
                     '08Punjabi Movies': self.bu[:-9] + 'language/punjabiMMMM7',
                     '09Bengali Movies': self.bu[:-9] + 'language/bengaliMMMM7',
                     '10Urdu Movies': self.bu[:-9] + 'language/urduMMMM7',
